...
@Component({
    selector: 'app-assetto-manageriale',
    templateUrl: './assetto-manageriale.component.html',
    styleUrls: ['./assetto-manageriale.component.scss']
})
//
export class AssettoManagerialeComponent implements OnInit {
    form = new FormGroup({});
    model: any = {};
